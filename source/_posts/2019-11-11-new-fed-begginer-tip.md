...
질문을 받고 멘토링을 해주며 느낀 점은 `제가(현재 2년차를 마무리하고 있는 부족한 실력의 주니어 개발자인 시점)`  
...
어쩌면 위와 같은 조건도 달리 생각하면 틀린 말은 아닙니다.  
...
>이를 판단하는 방법은 직접 이력서를 넣고 실패해보며 피드백을 받는 것이 가장 확실하고 빠릅니다.
...
기본적인 CS나 알고리즘 테스트를 통한 실력을 중점으로 하는 입사 프로세스로 지원하는 경우 아닐 때는
...
> 이 밖에도 다양한 방법과 경험을 살려 자신에게 맞는 구직 플랜과 꾸준한 학습 & 프로젝트 진행을 한다면  
